...
public class upload_files extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child(upload_Fhelp.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
